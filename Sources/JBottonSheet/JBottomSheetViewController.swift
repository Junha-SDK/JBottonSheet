...
public protocol JBottomSheetViewDelegate: AnyObject {
    func didMove(to percentage: Float)
}

public final class JBottomSheetViewController: UINavigationController {
    public let rootViewController = JBottomSheetRootViewController()
    ...
    public var state: JBottomSheetViewState = .collapsed {
        didSet {
    ...
    public var bottomSheetDelegate: JBottomSheetViewDelegate?
    ...
    public init(type: JBottomSheetType) {
        super.init(navigationBarClass: JNavigationBar.self, toolbarClass: nil)
        ...
        if let navigationBar = navigationBar as? JNavigationBar {
    ...
    public func show(in parentView: UIView, initialState: JBottomSheetViewState) {
    ...
    public func height(of state: JBottomSheetViewState) -> CGFloat {
        let height: CGFloat
        switch state {
        case .collapsed:
    ...
    private func constant(of state: JBottomSheetViewState) -> CGFloat {
        switch state {
        case .collapsed:
    ...
    @objc private func didPan(sender: UIPanGestureRecognizer) {
        ...
        case .ended:
            ...
            let state: JBottomSheetViewState
            switch newConstant {
...
extension JBottomSheetViewController {
...
extension JBottomSheetViewController: UIGestureRecognizerDelegate {
